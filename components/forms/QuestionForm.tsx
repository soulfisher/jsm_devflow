    ...
    const handleCreatQuestion = async (data: z.infer<typeof AskQuestionSchema>) => {
        startTransition(async () => {
            ...
            if (result.success) {
                toast({
                    title: 'Success',
                    description: 'Question created successsfully'
                });
    ...
    <FormField
        ...
        render={({ field }) => (
            ...
            <FormControl>
                <div>
                <Input
                className="paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 no-focus min-h-[56px] border" placeholder='Add tags'
                ...
                {field.value.length > 0 && (
                    ...
                    compact remove isButton handleRemove={() => handleTagRemove( tag, field)} />))}
                    </div>
                )}
            ...
            <FormDescription className='body-regular text-light500 mt-2.5'>
                Add upt to 3 tags to describe what your question 
